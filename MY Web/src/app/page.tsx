  ...
  return (
    <main className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      <Hero
        ...
        description="A junior full-stack vibe coder passionate about building modern web applications with a focus on security and clean code."
      />
            ...
            {[
              {
                ...
                description: "Modern web apps built with React, Next.js, and TypeScript with security in mind.",
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              },
              {
                ...
                description: "Secure backend solutions with Node.js, Python, PostgreSQL, and Supabase.",
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                description: "Vulnerability assessments, secure coding practices, and threat detection.",
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                description: "Fast, efficient applications with optimized load times and Core Web Vitals.",
              },
              {
                icon: (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                description: "Ongoing maintenance and security updates with quick response times.",
              },
            ].map((service, index) => (
